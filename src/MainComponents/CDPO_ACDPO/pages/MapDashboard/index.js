...
export class MapDashboard extends Component {
  ...
  firebaseLooper = snapshot => {
    ...
    snapshot.forEach(childSnapshot => {
      if (
        this.state.currentcdpoid ===
        childSnapshot.val().anganwadidetails.cdpoAcdpo
      ) {
  ...
  componentDidMount() {
    ...
    firebase
      ...
      .then(result => {
        var i = 0;
        const data = this.firebaseLooper(result);
        ...
        >
          ...
          >
            ...
            <InfoWindow
             ...
             onOpen={e => {this.onInfoWindowOpen1(this.props, e, this.state.selectedPlace);this.onInfoWindowOpen2(this.props,e,this.state.selectedPlace);}}
            >
              <div tabIndex="1">
                <div class="header">
                  <img
